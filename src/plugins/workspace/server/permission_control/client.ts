...
export class SavedObjectsPermissionControl {
  ...
  private _savedObjectCache: WeakMap<
    OpenSearchDashboardsRequest,
    { [key: string]: SavedObject }
  > = new WeakMap();
  private _shouldCachedSavedObjects: WeakMap<OpenSearchDashboardsRequest, string[]> = new WeakMap();
  /**
  ...
  public turnOnSavedObjectsCaching(
    request: OpenSearchDashboardsRequest,
  ...
  public clearSavedObjectsCaching(request: OpenSearchDashboardsRequest) {
    const requestKey = request;
